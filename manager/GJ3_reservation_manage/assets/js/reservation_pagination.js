...
function pagenation(selector, data) {
    ...
    for (let i = data.groupStart; i <= data.groupEnd; i++) {
        ...
        a2.setAttribute("href", "/GJ3_reservation_manage/reservation_manage.html.html?page=" + i + "&query=" + query);
    ...
    a3.setAttribute("href", "GJ3_reservation_manage/reservation_manage.html.html?page=" + data.nextGroupFirstPage + "&query=" + query);
